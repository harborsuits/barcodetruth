// Public cron wrapper: invokes internal calculate-baselines with INTERNAL_FN_TOKEN
...
Deno.serve(async (req) => {
  ...
  const url = `${SUPABASE_URL}/functions/v1/calculate-baselines`
  ...
  try {
    ...
    console.error('cron-calc-baselines error', err)
