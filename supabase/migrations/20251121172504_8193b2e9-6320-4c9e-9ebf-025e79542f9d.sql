-- Fix get_brand_ownership to use correct column name 'relationship' instead of 'relationship_type'
...
BEGIN
  -- Get the brand's company (FIXED: use 'relationship' column not 'relationship_type')
...
GRANT EXECUTE ON FUNCTION public.get_brand_ownership(uuid) TO anon, authenticated;