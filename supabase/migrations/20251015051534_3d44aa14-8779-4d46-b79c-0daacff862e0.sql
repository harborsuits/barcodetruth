-- Fix admin_add_evidence to use occurred_at (matching the unique constraint)
...
BEGIN
  ...
  -- Refresh coverage stats (if function exists)
  BEGIN
    PERFORM refresh_brand_coverage(p_brand_id);
