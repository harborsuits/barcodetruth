...
const STEPS = [
  ...
  },
  {
    ...
    body: "Choose ownership, ingredients, recalls, company actions or local shopping. See the sources and what is still unknown.",
  },
  {
    icon: ArrowRightLeft,
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h2 className="font-display font-bold text-2xl sm:text-3xl text-foreground">
            From a question to your next shop.
          </h2>
        </div>
