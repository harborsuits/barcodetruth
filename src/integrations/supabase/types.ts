  ...
  public: {
    Tables: {
      ...
      brand_corrections: {
        ...
        Relationships: [
          {
            foreignKeyName: "brand_corrections_brand_id_fkey"
            columns: ["brand_id"]
            isOneToOne: false
            referencedRelation: "brand_alias_suggestions"
            referencedColumns: ["suggested_brand_id"]
      ...
      reservoir_adjustments: {
        ...
        Relationships: [
          {
            foreignKeyName: "reservoir_adjustments_brand_id_fkey"
            columns: ["brand_id"]
            isOneToOne: false
            referencedRelation: "brand_alias_suggestions"
            referencedColumns: ["suggested_brand_id"]
      ...
      reservoir_signals: {
        ...
        Relationships: [
          {
            foreignKeyName: "reservoir_signals_brand_id_fkey"
            columns: ["brand_id"]
            isOneToOne: false
            referencedRelation: "brand_alias_suggestions"
            referencedColumns: ["suggested_brand_id"]
      ...
      seeding_errors: {
        ...
        Relationships: [
          {
            foreignKeyName: "seeding_errors_run_id_fkey"
            columns: ["run_id"]
            isOneToOne: false
            referencedRelation: "seeding_runs"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Views: {
      ...
      ingestion_metrics_daily: {
        Row: {
          avg_merge_rate: number | null
          day: string | null
          runs: number | null
          total_failed: number | null
          total_merged: number | null
      ...
      v_brand_confidence_pivot: {
        Row: {
          brand_id: string | null
          dimensions_with_evidence: number | null
          environment_confidence: string | null
          labor_confidence: string | null
          politics_confidence: string | null
          social_confidence: string | null
        }
        Relationships: []
      }
      v_brand_dimension_evidence: {
        Row: {
          brand_id: string | null
          confidence_level: string | null
